...
==================================\n"""+wi)
    ...
    def updateFaceBook():
        ...
        conn.request("GET", "/Oseid/FaceBook/master/core/version.txt")
        ...
        if repoVersion == currentVersion:write("  [*] The script is up to date!\n")
                ...
                conn.request("GET", "/Oseid/FaceBook/master/facebook.py")
                newCode = conn.getresponse().read().strip().decode()
                with open("facebook.py", "w") as  faceBookScript:
                   faceBookScript.write(newCode)
